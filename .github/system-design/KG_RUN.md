...
requirements:
  - id: REQ-KG-03
    ...
    covers:
      - main:tools/knowledge-graph/src/parseResults.test.ts
      - main:tools/knowledge-graph/src/resultsFile.test.ts
  - id: REQ-KG-RUN-01
    ...
    covers:
      - main:tools/knowledge-graph/src/resultsFile.test.ts
      - main:tools/knowledge-graph/src/lastRunPipeline.test.ts
  - id: REQ-KG-RUN-02
  ...
  - id: REQ-KG-RUN-03
    ...
    covers:
      - main:tools/knowledge-graph/src/runSchedule.test.ts
  - id: REQ-KG-RUN-04
    ...
    covers:
      - main:tools/knowledge-graph/src/treeKill.test.ts
  - id: REQ-KG-RUN-05
    ...
    covers:
      - main:tools/knowledge-graph/src/gateDecision.test.ts
---
